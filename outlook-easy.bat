...
if %whatapp%==1 (
	...
	Robocopy C:\Users\%UserInputPath%\AppData\Roaming\microsoft\outlook D:\userbackups\%UserInputPath%\backup\roaming\autocomplete *.nk2 /e
	echo Done
	pause
) else if %whatapp%==2 (
	...
	Robocopy D:\userbackups\%UserInputPath%\backup\roaming\autocomplete C:\Users\%UserInputPath%\AppData\Roaming\microsoft\outlook *.nk2 /e
	echo Done
	pause
) else if %whatapp%==3 (
	...
	Robocopy "C:\documents and settings\%UserInputPath%\application data\microsoft\outlook" D:\userbackups\%UserInputPath%\backup\roaming\autocomplete *.nk2 /e
	echo Done
	pause
) else if %whatapp%==4 (
	...
	Robocopy D:\userbackups\%UserInputPath%\backup\roaming\autocomplete "C:\documents and settings\%UserInputPath%\application data\microsoft\outlook" *.nk2 /e
	echo Done
	pause
) else (
    echo invalid choice
